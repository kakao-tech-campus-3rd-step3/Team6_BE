...
| `INVALID_ROOM_CODE`          | 유효하지 않은 방 코드입니다.           | 400        |

| **Room & WaitingRoom Error** |                             |            |
...
| `QUESTION_GENERATION_FAILED` | 질문 생성에 실패했습니다.            | 500        |
...
| `TOPIC_NOT_PRELOADED`        | 토픽이 사전 로드되지 않았습니다.         | 500        |
